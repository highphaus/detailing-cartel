  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#FFFFFF] font-sans antialiased selection:bg-[#E9001A] selection:text-white">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 rounded-full border border-emerald-400/20 bg-gradient-to-br from-[#25D366] to-[#20B358] shadow-[0_0_18px_rgba(37,211,102,0.25)] hover:shadow-[0_0_24px_rgba(37,211,102,0.4)] transition-all duration-300 transform hover:scale-105"
      >
