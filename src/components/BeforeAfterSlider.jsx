        ...
        <div className="lg:col-span-8 relative reveal-right">
          <div className="relative w-full aspect-[16/10] sm:aspect-[16/9] rounded-3xl overflow-hidden border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] select-none">
            ...
            <div className="absolute inset-0 bg-[#121214]">
              <img src={glossyPaint} alt="After: Ceramic Coated Paint" className="w-full h-full object-cover" />
            </div>
            ...
            >
              <img src={scratchPaint} alt="Before: Scratched Paint" className="w-full h-full object-cover" />
            </div>

            {/* Badges — always visible, outside any clipped layer */}
            <div 
              className="absolute left-6 bottom-6 bg-[#E9001A] px-4 py-2 rounded-lg z-20 pointer-events-none transition-opacity duration-300"
              style={{ opacity: sliderPosition < 12 ? 0 : 1 }}
            >
              <span className="text-[10px] font-bold tracking-widest text-white font-sans">Before</span>
            </div>
            <div 
              className="absolute right-6 bottom-6 bg-[#E9001A] px-4 py-2 rounded-lg z-20 pointer-events-none transition-opacity duration-300"
              style={{ opacity: sliderPosition > 88 ? 0 : 1 }}
            >
              <span className="text-[10px] font-bold tracking-widest text-white font-sans">After</span>
            </div>

            {/* Range input — top of stack */}
            <input 
